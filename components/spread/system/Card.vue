      ...
      <div class="input-phone">
        <sp-cell-group>
          <sp-field
            ...
            v-md-map
            v-md:webClick
            data-form_name="体系认证表单_手机号"
            data-form_type="咨询表单"
            type="tel"
            :border="false"
            maxlength="11"
            label="手机号"
            placeholder="留下手机号，接收优惠报价"
