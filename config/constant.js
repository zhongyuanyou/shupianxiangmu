...
const CHIPS_WAP_LAW_INSTANCE_NAME = 'crisps-law-wap-bff-api'
...
export const CHIPS_LAW_SPREAD_BASE_URL = `/${CHIPS_WAP_LAW_INSTANCE_NAME}/${CHIPS_WAP_SERVICE_PREFIX}` // 使用网关调用路径的规则：项目实例名 / 自己服务路径前缀
